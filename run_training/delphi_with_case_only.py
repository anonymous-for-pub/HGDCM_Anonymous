...
'''
Function for Fitting DELPHI using only Case Data from COVID for one location
Input 
...
def generate_and_save_delphi_performance(data_object):
    ...
    try: 
        ...
        outsample_mae, overall_mae, insample_mae, outsample_mape, overall_mape, insample_mape = visualize_result(x_sol[15],
                                    y_true,
                                    output_dir = f'/n/data1/hms/dbmi/farhat/alex/Pandemic-Early-Warning/output/delphi/case_only_{train_length}_{test_length}_plots/',
                                    data_object=data,
                                    type = 'case',
...
if __name__ == '__main__':
    ...
    with open('/n/data1/hms/dbmi/farhat/alex/Pandemic-Early-Warning/data_files/processed_data/validation/compartment_model_covid_data_objects.pickle', 'rb') as f:
    ...
    parameter_df.to_csv(f'/n/data1/hms/dbmi/farhat/alex/Pandemic-Early-Warning/output/delphi/covid_{train_length}_{test_length}_case_only_parameters.csv')
    performance_df.to_csv(f'/n/data1/hms/dbmi/farhat/alex/Pandemic-Early-Warning/output/delphi/covid_{train_length}_{test_length}_case_only_performance.csv')
    predicted_case_df.to_csv(f'/n/data1/hms/dbmi/farhat/alex/Pandemic-Early-Warning/output/delphi/covid_{train_length}_{test_length}_case_only_pred_case.csv')